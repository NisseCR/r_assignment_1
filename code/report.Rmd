...
```{r missing location, message = FALSE, echo=FALSE}
...
plot_cnt_covar <- function(plot) (
  plot
    ...
    + labs(x = "Humidity", y = "Number of bike rentals")
)
...
The anova test also reveals that adding the moderator significantly imporved model2. 

Thus, the final model we chose uses only humidity and temperature as predictors and includes day segments as a moderator. 
