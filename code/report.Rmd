...
### Expand `dteday` data
We decide to create a new variable 'dt_num' that provides a numeric value that represents to which out of the 731 days in the dataset a given hourly data point belongs. We create it by converting the `dteday` variable.
