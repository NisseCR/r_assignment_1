...
Then we checked the model fit improvement by verifying if the R^2 has significantly improved between adjacent models and finding the AIC, BIC and RMSE estimators. The best model  was identified based on these. 
```{r comparison}
RMSE <- function(model) {
