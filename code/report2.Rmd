...
## Interpretation of coefficents and the intercept {.tabset}
...
### Intercept
The intercept equals 0.302. Thus, the odds ratio of the proportion of registered rental bikes being higher than average to lower than average is equal to 0.302 when wheathersit is equal to 1 (lightest wheather phenomena), it is a non-workingday and humidity, temperature and windspeed are at their mean valu. 

### Workingday
The slope of workingday1 is equal to 8.356. Thus on a workingday the odds ratio of  the proportion of registered rental bikes being higher than average to lower than average is increases by 8.356 compared to a non-working day; if windspeed, temperature and humidity are equal to their mean value and 'wheathersit' is equal to 1.  

### Windspeed
The slope of windspeed is equal to 3.277. This means that for a unit increase in windspeed the odds ratio of the proportion of registered rental bikes being higher than average to lower than average is on average higher by 8.356 if temperature and humidity are fixed and 'workingday' and 'wheathersit' are equal to their reference categories (non-working day and 1, accordingly). 

### Temperature
The temperature's coefficient is equal to `r round( 3.263983e-04, digits = 3)`. This means that for a unit increase in temperature the odds ratio of the proportion of registered rental bikes being higher than average to lower than average changes on average by `r round( 3.263983e-04, digits = 3)`, if windspeed and humidity are fixed and 'workingday' and 'wheathersit' are equal to their reference categories. 

### Humidity 
The humidity's coefficient is equal to 2.465. This means that for a unit increase in humidity the odds ratio of the proportion of registered rental bikes being higher than average to lower than average is on average higher by 2.465; if windspeed and temperature are fixed and 'workingday' and 'wheathersit' are equal to their reference categories. 
...
The coefficients of weathersit2 (-0.139) and weathersit3 (0.230) represent the average diffrence in odds ratio between the reference  category (1) and categories 2 and 3 respectively, after controlling for windspeed, temperature, humidity and workingday.  
